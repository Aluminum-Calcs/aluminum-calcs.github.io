...
After completing my National Diploma, I spent some time in my uncle’s aluminum workshop to learn a practical skill.

While working there, I noticed that many tasks — especially calculations and pricing — were done manually using calculators. This often took time and could lead to mistakes.
...
- Calculating glass prices based on unit measurements  
